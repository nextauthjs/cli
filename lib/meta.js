...
5. Click next. An app will be created for you
6. Set the app name
7. Click on *App Settings*
8. Click *Set up* under *User authentication settings*
9. Choose *Type of app* - *Web App, Automated App or Bot* 
10. Add the callback URI (on your clipboard) to *Callback URLs* 
11. Fill out other required fields (your website)
12. Copy and paste the *Client key*
