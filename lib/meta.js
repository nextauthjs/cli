...
3. Choose a use case
4. Give it a description, an app will be created for you
5. Give an app name
6. Copy and paste the *API key(client key)*
7. Copy and paste the *API secret key(client secret)*
8. Click on *Authentication Settings*
9. Click *Set up* under *User authentication settings*
10. Choose app permission *request email from user*
11. Choose *Type of app* - *
Web App, Automated App or Bot* 
12. Add the callback URI (on your clipboard) to *Callback URLs* loclhost:3000/auth/callback/twitter
13. Fill out required fields (can be anything)
14. Click *Save*`,
  },
