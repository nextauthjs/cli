...
export const providers = {
  ...
  discord: {
    ...
    instructions: `\
      ...
      3. Set *Application name* (can be anything)
      4. Click on *OAuth2* in the side menu
      5. Click on *Add Redirect* and paste the callback URI (on your clipboard)
      6. Click on *Save Changes*
      7. Copy and paste the *Client ID*
      7. Copy and paste *Client Secret*
      `,
  },
...
7. Paste the *Client secret* back here (Note: This is the only time you can see it)`,
  ...
  linkedin: {
    name: "LinkedIn",
    setupUrl: "https://www.linkedin.com/developers/apps?appStatus=active",
    instructions: `\
